...
class HuikeDeveloperNjywvg extends Seeder
{
    /**
     * Run Method.
     *
    ...
    public function run()
    {
		...
		// id = 1
		think\facade\Db::table('huike_developer')->insert(['id' => 1,'username' => 'huikedev','password' => '$2y$10$SU1k1zhH3dodNXXmspk0nORR9N.2GrbTGH0N.FF4E5HB8PPxBDV9u','position_id' => 9,'last_login_ip' => '127.0.0.1','login_time' => 1614022825,'login_ip' => '127.0.0.1','last_login_time' => 1614016233,'creator_id' => 1,'create_time' => 1589639264,'update_time' => 1614022825]);
		// id = 2
