...
class HuikeFacadesTbvehf extends Seeder
{
    ...
    public function run()
    {
		...
		// id = 2
		think\facade\Db::table('huike_facades')->insert(['id' => 2,'origin_class' => 'huikedev\dev_admin\common\caching\provider\user\DeveloperCache','facade_class' => 'huikedev\dev_admin\common\caching\facade\DeveloperCache','facade_path' => 'huikedev\dev_admin\src\common\caching\facade','facade_title' => '开发者信息','type_id' => 3,'action_count' => 8,'creator_id' => 1,'create_time' => 1613731764,'update_time' => 1613731764]);
}
}